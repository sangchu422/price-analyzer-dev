...
> **폐기된 문서 (2026-07-27):** 아래 체크박스는 현재 작업 목록이 아니며
> 실행하거나 완료 상태를 갱신하지 않는다. 현재 인수인계와 후속 작업은
> `HANDOFF_2026-07-24.md`를 따른다.
...
- [ ] `/anomalies` — 이상가 품목 목록
- [x] `/report/{header_id}` 파일 출력 — **요구사항 폐기로 구현하지 않음**
