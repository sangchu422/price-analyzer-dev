...
_EXPORT_MODULES = {
    ...
    "standard_build_calculation_fingerprint": "app.standard_database.fingerprint",
    "standard_build_code_fingerprint": "app.standard_database.fingerprint",
    ...
    "StandardOperationalStatus": "app.standard_database.models",
    "StandardDatabaseBuildRun": "app.standard_database.models",
    "StandardDatabaseBuildProjection": "app.standard_database.models",
